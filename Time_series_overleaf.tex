...
star predictors with $\phi_t=\phi_\theta(\mathbf x_t)$. The (surrogate) log-likelihood is
\[
...
$\Phi_\theta:\mathcal X\to\mathbb R^{d_\alpha}$ jointly with the SLDS parameters $\Theta$, while retaining the IMM+star
