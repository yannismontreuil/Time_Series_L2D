...
echo "Running melbourne hyperparameter sweep under Slurm (array)..."

BASE_CONFIG="${SLURM_SUBMIT_DIR}/config/config_melbourne.yaml"
RUN_DIR="${SLURM_SUBMIT_DIR}/out/melbourne_sweep_${SLURM_JOB_ID}"
mkdir -p "${RUN_DIR}"
