...
\begin{itemize}[topsep=2pt,itemsep=1pt,parsep=0pt,leftmargin=1.2em]
    ...
    \item We empirically evaluate on a synthetic correlated-regime simulator and on Temperature in Melbourne \citep{daily_min_temp_melbourne_kaggle} (plus FRED DGS10 in the appendix), comparing against contextual bandit baselines and a no-shared-factor ablation (Section~\ref{sec:experiments}; Appendix~\ref{sec:experiments-details}).
\end{itemize}
